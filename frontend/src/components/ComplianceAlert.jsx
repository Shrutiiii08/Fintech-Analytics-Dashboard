...
export default function ComplianceAlert() {
  ...
  const [exceptions, setExceptions] = useState([
    { id: 'CMP-210', date: '2026-06-25', scheme: 'FinVista Smallcap Fund', guideline: 'SEBI Small-cap Asset Allocation Rule', details: 'Equity allocation dropped to 63.8% (min 65% required)', status: 'Open', risk: 'critical' },
    { id: 'CMP-194', date: '2026-06-24', scheme: 'FinVista Bluechip Fund', guideline: 'Single Stock Exposure Limit (Max 10%)', details: 'HDFC Bank exposure reached 10.45% due to price run-up', status: 'Open', risk: 'warning' },
    { id: 'CMP-108', date: '2026-06-21', scheme: 'FinVista Midcap Fund', guideline: 'SEBI Liquidity Buffer Rule', details: 'Cash reserves fell below 5% daily requirement', status: 'Resolved', risk: 'warning' },
    { id: 'CMP-042', date: '2026-06-18', scheme: 'FinVista Hybrid Equity Fund', guideline: 'Debt Asset Allocation Bracket (10-25%)', details: 'Debt exposure holding stable at 14.2%', status: 'Normal', risk: 'info' }
  ]);
